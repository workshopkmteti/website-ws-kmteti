...
export default function WhyUs() {
  return (
    <section id="why-us" className="relative flex flex-col items-center gap-2 px-6 py-20 sm:px-12 lg:px-24">
      <Mascot
        pose="happy"
        className="pointer-events-none absolute -bottom-4 -right-9.5 z-0 h-20 w-29 sm:bottom-6 sm:-right-11.5 sm:h-32 sm:w-46 md:bottom-10 md:-right-23 md:h-75 md:w-109 lg:bottom-12 lg:-right-16 lg:h-87.5 lg:w-126"
      />
