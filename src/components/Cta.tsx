export default function Cta() {
  return (
    <section id="register" className="flex flex-col items-center gap-10 px-6 pt-24 pb-32 text-center sm:pt-32 sm:pb-40">
      ...
      <a
        href="#"
        className="flex h-14 items-center justify-center rounded-2xl border-[1.2px] border-[#ebe6f0] bg-[#1e0339] px-9 font-mono text-base tracking-[0.02em] text-[#ebe6f0] transition-transform hover:scale-105"
      >
        Get Started
      </a>
    </section>
